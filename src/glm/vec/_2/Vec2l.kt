...
data class Vec2l(override var x: Long = 0, override var y: Long = 0) : Vec2t<Long>(x, y) {
    ...
    infix fun addAss(b: Vec2l) = glm.add(this, this, b.x, b.y)
    ...
    infix fun subAss(b: Vec2l) = glm.sub(this, this, b.x, b.y)
    ...
    infix fun mulAss(b: Vec2l) = glm.mul(this, this, b.x, b.y)
    ...
    infix fun divAss(b: Vec2l) = glm.div(this, this, b.x, b.y)
    ...
    infix fun modAss(b: Vec2l) = glm.mod(this, this, b.x, b.y)
    ...
    infix fun and(b: Long) = glm.and(Vec2l(), this, b, b)
    ...
    infix fun andAss(b: Vec2l) = glm.and(this, this, b.x, b.y)
    ...
    infix fun or(b: Long) = glm.or(Vec2l(), this, b, b)
    ...
    infix fun orAss(b: Vec2l) = glm.or(this, this, b.x, b.y)
    ...
    infix fun xor(b: Long) = glm.xor(Vec2l(), this, b, b)
    ...
    infix fun xorAss(b: Vec2l) = glm.xor(this, this, b.x, b.y)
...
infix fun Long.addAss(b: Vec2l) = glm.add(b, b, this, this)

operator fun Long.minus(b: Vec2l) = glm.sub(Vec2l(), this, this, b)
infix fun Long.subAss(b: Vec2l) = glm.sub(b, this, this, b)

operator fun Long.times(b: Vec2l) = glm.mul(Vec2l(), b, this, this)
infix fun Long.mulAss(b: Vec2l) = glm.mul(b, b, this, this)

operator fun Long.div(b: Vec2l) = glm.div(Vec2l(), this, this, b)
infix fun Long.divAss(b: Vec2l) = glm.div(b, this, this, b)

operator fun Long.mod(b: Vec2l) = glm.mod(Vec2l(), this, this, b)
infix fun Long.modAss(b: Vec2l) = glm.mod(b, this, this, b)