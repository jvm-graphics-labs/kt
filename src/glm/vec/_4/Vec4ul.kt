...
data class Vec4ul(override var x: Ulong = Ulong(0), override var y: Ulong = Ulong(0), override var z: Ulong = Ulong(0), override var w: Ulong = Ulong(0)) : Vec4t<Ulong>(x, y, z, w) {
    ...
    infix fun addAss(b: Ulong) = glm.add(this, this, b, b, b, b)
    infix fun addAss(b: Long) = glm.add(this, this, b, b, b, b)
    ...
    infix fun addAss(b: Vec4ul) = glm.add(this, this, b.x, b.y, b.z, b.w)
    ...
    infix fun subAss(b: Ulong) = glm.sub(this, this, b, b, b, b)
    infix fun subAss(b: Long) = glm.sub(this, this, b, b, b, b)
    ...
    infix fun subAss(b: Vec4ul) = glm.sub(this, this, b.x, b.y, b.z, b.w)
    ...
    infix fun mulAss(b: Ulong) = glm.mul(this, this, b, b, b, b)
    infix fun mulAss(b: Long) = glm.mul(this, this, b, b, b, b)
    ...
    infix fun mulAss(b: Vec4ul) = glm.mul(this, this, b.x, b.y, b.z, b.w)
    ...
    infix fun divAss(b: Ulong) = glm.div(this, this, b, b, b, b)
    infix fun divAss(b: Long) = glm.div(this, this, b, b, b, b)
    ...
    infix fun divAss(b: Vec4ul) = glm.div(this, this, b.x, b.y, b.z, b.w)
    ...
    infix fun modAss(b: Ulong) = glm.mod(this, this, b, b, b, b)
    infix fun modAss(b: Long) = glm.mod(this, this, b, b, b, b)
    ...
    infix fun modAss(b: Vec4ul) = glm.mod(this, this, b.x, b.y, b.z, b.w)
    ...
    infix fun and(b: Ulong) = glm.and(Vec4ul(), this, b, b, b, b)
    infix fun and(b: Long) = glm.and(Vec4ul(), this, b, b, b, b)
    ...
    infix fun andAss(b: Ulong) = glm.and(this, this, b, b, b, b)
    infix fun andAss(b: Long) = glm.and(this, this, b, b, b, b)
    ...
    infix fun andAss(b: Vec4ul) = glm.and(this, this, b.x, b.y, b.z, b.w)
    ...
    infix fun or(b: Ulong) = glm.or(Vec4ul(), this, b, b, b, b)
    infix fun or(b: Long) = glm.or(Vec4ul(), this, b, b, b, b)
    ...
    infix fun orAss(b: Ulong) = glm.or(this, this, b, b, b, b)
    infix fun orAss(b: Long) = glm.or(this, this, b, b, b, b)
    ...
    infix fun orAss(b: Vec4ul) = glm.or(this, this, b.x, b.y, b.z, b.w)
    ...
    infix fun xor(b: Ulong) = glm.xor(Vec4ul(), this, b, b, b, b)
    infix fun xor(b: Long) = glm.xor(Vec4ul(), this, b, b, b, b)
    ...
    infix fun xorAss(b: Ulong) = glm.xor(this, this, b, b, b, b)
    infix fun xorAss(b: Long) = glm.xor(this, this, b, b, b, b)
    ...
    infix fun xorAss(b: Vec4ul) = glm.xor(this, this, b.x, b.y, b.z, b.w)
    ...
    infix fun shl(b: Int) = glm.shl(Vec4ul(), this, b, b, b, b)
    ...
    infix fun shr(b: Int) = glm.shr(Vec4ul(), this, b, b, b, b)
...
infix fun Ulong.addAss(b: Vec4ul) = glm.add(b, b, this, this, this, this)

operator fun Ulong.minus(b: Vec4ul) = glm.sub(Vec4ul(), this, this, this, this, b)
infix fun Ulong.subAss(b: Vec4ul) = glm.sub(b, this, this, this, this, b)

operator fun Ulong.times(b: Vec4ul) = glm.mul(Vec4ul(), b, this, this, this, this)
infix fun Ulong.mulAss(b: Vec4ul) = glm.mul(b, b, this, this, this, this)

operator fun Ulong.div(b: Vec4ul) = glm.div(Vec4ul(), this, this, this, this, b)
infix fun Ulong.divAss(b: Vec4ul) = glm.div(b, this, this, this, this, b)

operator fun Ulong.mod(b: Vec4ul) = glm.mod(Vec4ul(), this, this, this, this, b)
infix fun Ulong.modAss(b: Vec4ul) = glm.mod(b, this, this, this, this, b)


operator fun Long.plus(b: Vec4ul) = glm.add(Vec4ul(), b, this, this, this, this)
infix fun Long.addAss(b: Vec4ul) = glm.add(b, b, this, this, this, this)

operator fun Long.minus(b: Vec4ul) = glm.sub(Vec4ul(), this, this, this, this, b)
infix fun Long.subAss(b: Vec4ul) = glm.sub(b, this, this, this, this, b)

operator fun Long.times(b: Vec4ul) = glm.mul(Vec4ul(), b, this, this, this, this)
infix fun Long.mulAss(b: Vec4ul) = glm.mul(b, b, this, this, this, this)

operator fun Long.div(b: Vec4ul) = glm.div(Vec4ul(), this, this, this, this, b)
infix fun Long.divAss(b: Vec4ul) = glm.div(b, this, this, this, this, b)

operator fun Long.mod(b: Vec4ul) = glm.mod(Vec4ul(), this, this, this, this, b)
infix fun Long.modAss(b: Vec4ul) = glm.mod(b, this, this, this, this, b)