...
data class Vec4b(override var x: Byte = 0, override var y: Byte = 0, override var z: Byte = 0, override var w: Byte = 0) : Vec4t<Byte>(x, y, z, w) {
    ...
    infix fun addAss(b: Byte) = glm.add(this, this, b, b, b, b)
    ...
    infix fun addAss(b: Vec4b) = glm.add(this, this, b.x, b.y, b.z, b.w)
    ...
    infix fun subAss(b: Byte) = glm.sub(this, this, b, b, b, b)
    ...
    infix fun subAss(b: Vec4b) = glm.sub(this, this, b.x, b.y, b.z, b.w)
    ...
    infix fun mulAss(b: Byte) = glm.mul(this, this, b, b, b, b)
    ...
    infix fun mulAss(b: Vec4b) = glm.mul(this, this, b.x, b.y, b.z, b.w)
    ...
    infix fun divAss(b: Byte) = glm.div(this, this, b, b, b, b)
    ...
    infix fun divAss(b: Vec4b) = glm.div(this, this, b.x, b.y, b.z, b.w)
    ...
    infix fun modAss(b: Byte) = glm.mod(this, this, b, b, b, b)
    ...
    infix fun modAss(b: Vec4b) = glm.mod(this, this, b.x, b.y, b.z, b.w)
    ...
    infix fun and(b: Byte) = glm.and(Vec4b(), this, b, b, b, b)
    infix fun and(b: Int) = glm.and(Vec4b(), this, b, b, b, b)
    ...
    infix fun andAss(b: Byte) = glm.and(this, this, b, b, b, b)
    ...
    infix fun andAss(b: Vec4b) = glm.and(this, this, b.x, b.y, b.z, b.w)
    ...
    infix fun or(b: Byte) = glm.or(Vec4b(), this, b, b, b, b)
    infix fun or(b: Int) = glm.or(Vec4b(), this, b, b, b, b)
    ...
    infix fun orAss(b: Byte) = glm.or(this, this, b, b, b, b)
    ...
    infix fun orAss(b: Vec4b) = glm.or(this, this, b.x, b.y, b.z, b.w)
    ...
    infix fun xor(b: Byte) = glm.xor(Vec4b(), this, b, b, b, b)
    infix fun xor(b: Int) = glm.xor(Vec4b(), this, b, b, b, b)
    ...
    infix fun xorAss(b: Byte) = glm.xor(this, this, b, b, b, b)
    ...
    infix fun xorAss(b: Vec4b) = glm.xor(this, this, b.x, b.y, b.z, b.w)
    ...
    infix fun shl(b: Byte) = glm.shl(Vec4b(), this, b, b, b, b)
    infix fun shl(b: Int) = glm.shl(Vec4b(), this, b, b, b, b)
    ...
    infix fun shlAss(b: Byte) = glm.shl(this, this, b, b, b, b)
    ...
    infix fun shlAss(b: Vec4b) = glm.shl(this, this, b.x, b.y, b.z, b.w)
    ...
    infix fun shr(b: Byte) = glm.shr(Vec4b(), this, b, b, b, b)
    infix fun shr(b: Int) = glm.shr(Vec4b(), this, b, b, b, b)
    ...
    infix fun shrAss(b: Byte) = glm.shr(this, this, b, b, b, b)
    ...
    infix fun shrAss(b: Vec4b) = glm.shr(this, this, b.x, b.y, b.z, b.w)
...
infix fun Byte.addAss(b: Vec4b) = glm.add(b, b, this, this, this, this)

operator fun Byte.minus(b: Vec4b) = glm.sub(Vec4b(), this, this, this, this, b)
infix fun Byte.subAss(b: Vec4b) = glm.sub(b, this, this, this, this, b)

operator fun Byte.times(b: Vec4b) = glm.mul(Vec4b(), b, this, this, this, this)
infix fun Byte.mulAss(b: Vec4b) = glm.mul(b, b, this, this, this, this)

operator fun Byte.div(b: Vec4b) = glm.div(Vec4b(), this, this, this, this, b)
infix fun Byte.divAss(b: Vec4b) = glm.div(b, this, this, this, this, b)

operator fun Byte.mod(b: Vec4b) = glm.mod(Vec4b(), this, this, this, this, b)
infix fun Byte.modAss(b: Vec4b) = glm.mod(b, this, this, this, this, b)


operator fun Int.plus(b: Vec4b) = glm.add(Vec4b(), b, this, this, this, this)
infix fun Int.addAss(b: Vec4b) = glm.add(b, b, this, this, this, this)

operator fun Int.minus(b: Vec4b) = glm.sub(Vec4b(), this, this, this, this, b)
infix fun Int.subAss(b: Vec4b) = glm.sub(b, this, this, this, this, b)

operator fun Int.times(b: Vec4b) = glm.mul(Vec4b(), b, this, this, this, this)
infix fun Int.mulAss(b: Vec4b) = glm.mul(b, b, this, this, this, this)

operator fun Int.div(b: Vec4b) = glm.div(Vec4b(), this, this, this, this, b)
infix fun Int.divAss(b: Vec4b) = glm.div(b, this, this, this, this, b)

operator fun Int.mod(b: Vec4b) = glm.mod(Vec4b(), this, this, this, this, b)
infix fun Int.modAss(b: Vec4b) = glm.mod(b, this, this, this, this, b)