...
data class Vec4l(override var x: Long = 0, override var y: Long = 0, override var z: Long = 0, override var w: Long = 0) : Vec4t<Long>(x, y, z, w) {
    ...
    infix fun addAss(b: Vec4l) = glm.add(this, this, b.x, b.y, b.z, b.w)
    ...
    infix fun subAss(b: Vec4l) = glm.sub(this, this, b.x, b.y, b.z, b.w)
    ...
    infix fun mulAss(b: Vec4l) = glm.mul(this, this, b.x, b.y, b.z, b.w)
    ...
    infix fun divAss(b: Vec4l) = glm.div(this, this, b.x, b.y, b.z, b.w)
    ...
    infix fun modAss(b: Vec4l) = glm.mod(this, this, b.x, b.y, b.z, b.w)
    ...
    infix fun and(b: Long) = glm.and(Vec4l(), this, b, b, b, b)
    ...
    infix fun andAss(b: Vec4l) = glm.and(this, this, b.x, b.y, b.z, b.w)
    ...
    infix fun or(b: Long) = glm.or(Vec4l(), this, b, b, b, b)
    ...
    infix fun orAss(b: Vec4l) = glm.or(this, this, b.x, b.y, b.z, b.w)
    ...
    infix fun xor(b: Long) = glm.xor(Vec4l(), this, b, b, b, b)
    ...
    infix fun xorAss(b: Vec4l) = glm.xor(this, this, b.x, b.y, b.z, b.w)
...
infix fun Long.addAss(b: Vec4l) = glm.add(b, b, this, this, this, this)

operator fun Long.minus(b: Vec4l) = glm.sub(Vec4l(), this, this, this, this, b)
infix fun Long.subAss(b: Vec4l) = glm.sub(b, this, this, this, this, b)

operator fun Long.times(b: Vec4l) = glm.mul(Vec4l(), b, this, this, this, this)
infix fun Long.mulAss(b: Vec4l) = glm.mul(b, b, this, this, this, this)

operator fun Long.div(b: Vec4l) = glm.div(Vec4l(), this, this, this, this, b)
infix fun Long.divAss(b: Vec4l) = glm.div(b, this, this, this, this, b)

operator fun Long.mod(b: Vec4l) = glm.mod(Vec4l(), this, this, this, this, b)
infix fun Long.modAss(b: Vec4l) = glm.mod(b, this, this, this, this, b)