...
data class Vec4s(override var x: Short = 0, override var y: Short = 0, override var z: Short = 0, override var w: Short = 0) : Vec4t<Short>(x, y, z, w) {
    ...
    infix inline fun addAss(b: Short) = glm.add(this, this, b, b, b, b)
    ...
    infix inline fun addAss(b: Vec4s) = glm.add(this, this, b.x, b.y, b.z, b.w)
    ...
    infix inline fun subAss(b: Short) = glm.sub(this, this, b, b, b, b)
    ...
    infix inline fun subAss(b: Vec4s) = glm.sub(this, this, b.x, b.y, b.z, b.w)
    ...
    infix inline fun mulAss(b: Short) = glm.mul(this, this, b, b, b, b)
    ...
    infix inline fun mulAss(b: Vec4s) = glm.mul(this, this, b.x, b.y, b.z, b.w)
    ...
    infix inline fun divAss(b: Short) = glm.div(this, this, b, b, b, b)
    ...
    infix inline fun divAss(b: Vec4s) = glm.div(this, this, b.x, b.y, b.z, b.w)
    ...
    infix inline fun modAss(b: Short) = glm.mod(this, this, b, b, b, b)
    ...
    infix inline fun modAss(b: Vec4s) = glm.mod(this, this, b.x, b.y, b.z, b.w)
    ...
    inline infix fun and(b: Short) = glm.and(Vec4s(), this, b, b, b, b)
    inline infix fun and(b: Int) = glm.and(Vec4s(), this, b, b, b, b)
    ...
    infix inline fun andAss(b: Short) = glm.and(this, this, b, b, b, b)
    ...
    infix inline fun andAss(b: Vec4s) = glm.and(this, this, b.x, b.y, b.z, b.w)
    ...
    inline infix fun or(b: Short) = glm.or(Vec4s(), this, b, b, b, b)
    inline infix fun or(b: Int) = glm.or(Vec4s(), this, b, b, b, b)
    ...
    infix inline fun orAss(b: Short) = glm.or(this, this, b, b, b, b)
    ...
    infix inline fun orAss(b: Vec4s) = glm.or(this, this, b.x, b.y, b.z, b.w)
    ...
    inline infix fun xor(b: Short) = glm.xor(Vec4s(), this, b, b, b, b)
    inline infix fun xor(b: Int) = glm.xor(Vec4s(), this, b, b, b, b)
    ...
    infix inline fun xorAss(b: Short) = glm.xor(this, this, b, b, b, b)
    ...
    infix inline fun xorAss(b: Vec4s) = glm.xor(this, this, b.x, b.y, b.z, b.w)
    ...
    inline infix fun shl(b: Short) = glm.shl(Vec4s(), this, b, b, b, b)
    inline infix fun shl(b: Int) = glm.shl(Vec4s(), this, b, b, b, b)
    ...
    infix inline fun shlAss(b: Short) = glm.shl(this, this, b, b, b, b)
    ...
    infix inline fun shlAss(b: Vec4s) = glm.shl(this, this, b.x, b.y, b.z, b.w)
    ...
    inline infix fun shr(b: Short) = glm.shr(Vec4s(), this, b, b, b, b)
    inline infix fun shr(b: Int) = glm.shr(Vec4s(), this, b, b, b, b)
    ...
    infix inline fun shrAss(b: Short) = glm.shr(this, this, b, b, b, b)
    ...
    infix inline fun shrAss(b: Vec4s) = glm.shr(this, this, b.x, b.y, b.z, b.w)
...
inline infix fun Short.addAss(b: Vec4s) = glm.add(b, b, this, this, this, this)

operator fun Short.minus(b: Vec4s) = glm.sub(Vec4s(), this, this, this, this, b)
inline infix fun Short.subAss(b: Vec4s) = glm.sub(b, this, this, this, this, b)

operator fun Short.times(b: Vec4s) = glm.mul(Vec4s(), b, this, this, this, this)
inline infix fun Short.mulAss(b: Vec4s) = glm.mul(b, b, this, this, this, this)

operator fun Short.div(b: Vec4s) = glm.div(Vec4s(), this, this, this, this, b)
inline infix fun Short.divAss(b: Vec4s) = glm.div(b, this, this, this, this, b)

operator fun Short.mod(b: Vec4s) = glm.mod(Vec4s(), this, this, this, this, b)
inline infix fun Short.modAss(b: Vec4s) = glm.mod(b, this, this, this, this, b)


operator fun Int.plus(b: Vec4s) = glm.add(Vec4s(), b, this, this, this, this)
inline infix fun Int.addAss(b: Vec4s) = glm.add(b, b, this, this, this, this)

operator fun Int.minus(b: Vec4s) = glm.sub(Vec4s(), this, this, this, this, b)
inline infix fun Int.subAss(b: Vec4s) = glm.sub(b, this, this, this, this, b)

operator fun Int.times(b: Vec4s) = glm.mul(Vec4s(), b, this, this, this, this)
inline infix fun Int.mulAss(b: Vec4s) = glm.mul(b, b, this, this, this, this)

operator fun Int.div(b: Vec4s) = glm.div(Vec4s(), this, this, this, this, b)
inline infix fun Int.divAss(b: Vec4s) = glm.div(b, this, this, this, this, b)

operator fun Int.mod(b: Vec4s) = glm.mod(Vec4s(), this, this, this, this, b)
inline infix fun Int.modAss(b: Vec4s) = glm.mod(b, this, this, this, this, b)