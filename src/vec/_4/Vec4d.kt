...
data class Vec4d(override var x: Double = 0.0, override var y: Double = 0.0, override var z: Double = 0.0, override var w: Double = 0.0) : Vec4t<Double>(x, y, z, w) {
    ...
    infix inline fun addAss(b: Double) = glm.add(this, this, b, b, b, b)
    fun addAss(bX: Double, bY: Double, bZ: Double, bW: Double) = glm.add(this, this, bX, bY, bZ, bW)
    infix inline fun addAss(b: Vec4d) = glm.add(this, this, b.x, b.y, b.z, b.w)
    ...
    infix inline fun subAss(b: Double) = glm.sub(this, this, b, b, b, b)
    fun subAss(bX: Double, bY: Double, bZ: Double, bW: Double) = glm.sub(this, this, bX, bY, bZ, bW)
    infix inline fun subAss(b: Vec4d) = glm.sub(this, this, b.x, b.y, b.z, b.w)
    ...
    infix inline fun mulAss(b: Double) = glm.mul(this, this, b, b, b, b)
    fun mulAss(bX: Double, bY: Double, bZ: Double, bW: Double) = glm.mul(this, this, bX, bY, bZ, bW)
    infix inline fun mulAss(b: Vec4d) = glm.mul(this, this, b.x, b.y, b.z, b.w)
    ...
    infix inline fun divAss(b: Double) = glm.div(this, this, b, b, b, b)
    fun divAss(bX: Double, bY: Double, bZ: Double, bW: Double) = glm.div(this, this, bX, bY, bZ, bW)
    infix inline fun divAss(b: Vec4d) = glm.div(this, this, b.x, b.y, b.z, b.w)
    ...
    infix inline fun modAss(b: Double) = glm.mod(this, this, b, b, b, b)
    fun modAss(bX: Double, bY: Double, bZ: Double, bW: Double) = glm.mod(this, this, bX, bY, bZ, bW)
    infix inline fun modAss(b: Vec4d) = glm.mod(this, this, b.x, b.y, b.z, b.w)
...
inline infix fun Double.addAss(b: Vec4d) = glm.add(b, b, this, this, this, this)

operator fun Double.minus(b: Vec4d) = glm.sub(Vec4d(), this, this, this, this, b)
inline infix fun Double.subAss(b: Vec4d) = glm.sub(b, b, this, this, this, this)

operator fun Double.times(b: Vec4d) = glm.mul(Vec4d(), b, this, this, this, this)
inline infix fun Double.mulAss(b: Vec4d) = glm.mul(b, b, this, this, this, this)

operator fun Double.div(b: Vec4d) = glm.div(Vec4d(), this, this, this, this, b)
inline infix fun Double.divAss(b: Vec4d) = glm.div(b, this, this, this, this, b)

operator fun Double.mod(b: Vec4d) = glm.mod(Vec4d(), this, this, this, this, b)
inline infix fun Double.modAss(b: Vec4d) = glm.mod(b, this, this, this, this, b)