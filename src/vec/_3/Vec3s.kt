...
data class Vec3s(override var x: Short = 0, override var y: Short = 0, override var z: Short = 0) : Vec3t<Short>(x, y, z) {
    ...
    infix inline fun addAss(b: Short) = glm.add(this, this, b, b, b)
    ...
    infix inline fun addAss(b: Vec3s) = glm.add(this, this, b.x, b.y, b.z)
    ...
    infix inline fun subAss(b: Short) = glm.sub(this, this, b, b, b)
    ...
    infix inline fun subAss(b: Vec3s) = glm.sub(this, this, b.x, b.y, b.z)
    ...
    infix inline fun mulAss(b: Short) = glm.mul(this, this, b, b, b)
    ...
    infix inline fun mulAss(b: Vec3s) = glm.mul(this, this, b.x, b.y, b.z)
    ...
    infix inline fun divAss(b: Short) = glm.div(this, this, b, b, b)
    ...
    infix inline fun divAss(b: Vec3s) = glm.div(this, this, b.x, b.y, b.z)
    ...
    infix inline fun modAss(b: Short) = glm.mod(this, this, b, b, b)
    ...
    infix inline fun modAss(b: Vec3s) = glm.mod(this, this, b.x, b.y, b.z)
    ...
    inline infix fun and(b: Short) = glm.and(Vec3s(), this, b, b, b)
    inline infix fun and(b: Int) = glm.and(Vec3s(), this, b, b, b)
    ...
    infix inline fun andAss(b: Short) = glm.and(this, this, b, b, b)
    ...
    infix inline fun andAss(b: Vec3s) = glm.and(this, this, b.x, b.y, b.z)
    ...
    inline infix fun or(b: Short) = glm.or(Vec3s(), this, b, b, b)
    inline infix fun or(b: Int) = glm.or(Vec3s(), this, b, b, b)
    ...
    infix inline fun orAss(b: Short) = glm.or(this, this, b, b, b)
    ...
    infix inline fun orAss(b: Vec3s) = glm.or(this, this, b.x, b.y, b.z)
    ...
    inline infix fun xor(b: Short) = glm.xor(Vec3s(), this, b, b, b)
    inline infix fun xor(b: Int) = glm.xor(Vec3s(), this, b, b, b)
    ...
    infix inline fun xorAss(b: Short) = glm.xor(this, this, b, b, b)
    ...
    infix inline fun xorAss(b: Vec3s) = glm.xor(this, this, b.x, b.y, b.z)
    ...
    inline infix fun shl(b: Short) = glm.shl(Vec3s(), this, b, b, b)
    inline infix fun shl(b: Int) = glm.shl(Vec3s(), this, b, b, b)
    ...
    infix inline fun shlAss(b: Short) = glm.shl(this, this, b, b, b)
    ...
    infix inline fun shlAss(b: Vec3s) = glm.shl(this, this, b.x, b.y, b.z)
    ...
    inline infix fun shr(b: Short) = glm.shr(Vec3s(), this, b, b, b)
    inline infix fun shr(b: Int) = glm.shr(Vec3s(), this, b, b, b)
    ...
    infix inline fun shrAss(b: Short) = glm.shr(this, this, b, b, b)
    ...
    infix inline fun shrAss(b: Vec3s) = glm.shr(this, this, b.x, b.y, b.z)
...
inline infix fun Short.addAss(b: Vec3s) = glm.add(b, b, this, this, this)

operator fun Short.minus(b: Vec3s) = glm.sub(Vec3s(), this, this, this, b)
inline infix fun Short.subAss(b: Vec3s) = glm.sub(b, this, this, this, b)

operator fun Short.times(b: Vec3s) = glm.mul(Vec3s(), b, this, this, this)
inline infix fun Short.mulAss(b: Vec3s) = glm.mul(b, b, this, this, this)

operator fun Short.div(b: Vec3s) = glm.div(Vec3s(), this, this, this, b)
inline infix fun Short.divAss(b: Vec3s) = glm.div(b, this, this, this, b)

operator fun Short.mod(b: Vec3s) = glm.mod(Vec3s(), this, this, this, b)
inline infix fun Short.modAss(b: Vec3s) = glm.mod(b, this, this, this, b)


operator fun Int.plus(b: Vec3s) = glm.add(Vec3s(), b, this, this, this)
inline infix fun Int.addAss(b: Vec3s) = glm.add(b, b, this, this, this)

operator fun Int.minus(b: Vec3s) = glm.sub(Vec3s(), this, this, this, b)
inline infix fun Int.subAss(b: Vec3s) = glm.sub(b, this, this, this, b)

operator fun Int.times(b: Vec3s) = glm.mul(Vec3s(), b, this, this, this)
inline infix fun Int.mulAss(b: Vec3s) = glm.mul(b, b, this, this, this)

operator fun Int.div(b: Vec3s) = glm.div(Vec3s(), this, this, this, b)
inline infix fun Int.divAss(b: Vec3s) = glm.div(b, this, this, this, b)

operator fun Int.mod(b: Vec3s) = glm.mod(Vec3s(), this, this, this, b)
inline infix fun Int.modAss(b: Vec3s) = glm.mod(b, this, this, this, b)